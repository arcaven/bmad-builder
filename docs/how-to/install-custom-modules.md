...
Your custom content needs a `module.yaml` file at its root, along with an optional module-help.csv.

```
module-code/
  module.yaml
  module-help.csv  # optional
  agents/
  workflows/
```
...
2. Recompile all agents with your customizations
...
Find example custom modules in the `samples/sample-custom-modules/` folder of the [BMad repository](https://github.com/bmad-code-org/BMAD-METHOD). Download either sample folder to try to install them!
